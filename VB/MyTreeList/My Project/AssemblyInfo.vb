...
<Assembly: AssemblyTitle("MyTreeList"), assembly: AssemblyDescription(""), assembly: AssemblyConfiguration(""), assembly: AssemblyCompany("Microsoft"), assembly: AssemblyProduct("MyTreeList"), assembly: AssemblyCopyright("Copyright © Microsoft 2011"), assembly: AssemblyTrademark(""), assembly: AssemblyCulture("")>
' Setting ComVisible to false makes the types in this assembly not visible 
' to COM components.  If you need to access a type in this assembly from 
' COM, set the ComVisible attribute to true on that type.
<Assembly: ComVisible(False)>
' The following GUID is for the ID of the typelib if this project is exposed to COM
<Assembly: Guid("ffa64768-1b2e-4f15-b80e-f39e56e35f9f")>
